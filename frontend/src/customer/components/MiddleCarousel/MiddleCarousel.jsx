...
const items = [
    ...
    <div className="item hover:shadow-2xl  mt-[100px] mb-[30px] border border-gray-200 rounded m-[10px] " data-value="1">
        <img
            ...
            alt="asd"
        />
        <p className='text-center mt-[50px] tracking-widest font-text'>
            KYRA MINI DRESS ~ CORAL
        </p>
        <div className='text-center text-xs mt-[20px] mb-[20px]'>
            <span className='font-text line-through'>Rs. 11,800.00 &nbsp;</span>
            <span className='font-text'>&nbsp;Rs. 8,800.00 &nbsp;</span>
            <span className='font-text text-[#cc2a2a]'>
                Save 25%
            </span>
        </div>
