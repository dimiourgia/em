...
const Collections = () => {
    ...
    return (
        <>
            <div className='w-full bg-heading-bg mt-[295px] md:w-1/3 px-3 md:mb-0' id='collection-section'>
            ...
            <div className="container min-h-[calc(100vh-150px)] mx-auto px-4 mt-4">
                <div className="w-full mx-auto">
                   { collections != null && collections!= undefined && collections.length >0 &&      
                    ...
                    {collections == null || collections == undefined || collections.length == 0 &&
                        <CarouselComponent items={ [<PlaceholderCard />, <PlaceholderCard />, <PlaceholderCard />] } 
                            />}
                </div>
            </div>
