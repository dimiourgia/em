...
//                 <div className='mx-auto w-full md:w-1/3 px-3 md:mb-0  max-w-[1000px] tracking-widest font-light text-black  text-2xl  font-text'>
//                     Order History
//                 </div>
...
//                                 <h1 className='tracking-widest font-text font-bold text-base '>
//                                     Title
//                                 </h1>
...
//                                     Order No
//                                 </h1>
//                                 <p className='text-blue-800 font-text font-bold'>
//                                     #8008580085
//                                 </p>
//                             </div>
//                         </div>
