...
const JournalDetailPage = () => {
    return (
        <div className='min-h-screen w-full md:w-1/3 px-3 mb-36'>
            <h1 className="font-ijk text-center text-xs text-gray-800">
                Apr 01, 2024
            </h1>
            <h1 className="font-ijk text-center text-3xl text-black">
            ...
            <div className='mx-auto flex justify-center items-center mt-10 max-w-screen-lg'>
                <img className='w-full h-auto' src="images/38.jpg" alt="Journal detail image 38" loading="lazy" />
            </div>
            <div className='mx-auto max-w-screen-lg'>
                <p className='font-ijk text-base text-gray-800 mt-24'>
                ...
                <p className='font-ijk text-base text-gray-800 mt-5'>
                ...
                <img className='mt-12 w-full h-auto' src="images/39.jpg" alt="Journal detail image 39" loading="lazy" />
                <p className='font-ijk text-base text-gray-800 mt-5'>
                ...
                <img className='mt-12 w-full h-auto' src="images/40.webp" alt="Journal detail image 40" loading="lazy" />
            </div>
        </div>
    );
}
